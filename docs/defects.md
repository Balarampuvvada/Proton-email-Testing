...
- Latest isolated reruns provide additional evidence: ATT-01 completed the attachment workflow but did not find the received message within its 60-second receiver poll; FLT-01 timed out after 120 seconds while waiting for the receiver Archive navigation control. Both failures occurred after the sender-side actions and remain classified as delivery/account-state timing constraints.
